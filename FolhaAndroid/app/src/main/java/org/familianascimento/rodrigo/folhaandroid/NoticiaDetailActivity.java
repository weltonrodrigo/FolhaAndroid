 ...
 * more than a {@link NoticiaDetailFragment}.
 */
public class NoticiaDetailActivity extends Activity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            NavUtils.navigateUpTo(this, new Intent(this, NoticiaListActivity.class));
            return true;
        }
